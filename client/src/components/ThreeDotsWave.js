...
const loadingCircle = {
    ...
    width: "0.5rem",
    height: "0.5rem",
    backgroundColor: "#E800C6",
    borderRadius: "0.25rem"
};

const loadingCircleMiddle = {
    display: "block",
    width: "0.5rem",
    height: "0.5rem",
...
function ThreeDotsWave(props) {
    ...
    <motion.span style={loadingCircleMiddle} variants={loadingCircleVariants} transition={loadingCircleTransition} />
    <motion.span style={loadingCircle} variants={loadingCircleVariants} transition={loadingCircleTransition} />
     </motion.div>
     </div>
    );
