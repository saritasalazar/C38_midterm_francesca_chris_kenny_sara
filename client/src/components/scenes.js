...
export const drinkScene = {
  ...
  image2: { src: Drink2, alt: 'Picture of Cocktail' },
  image3: { src: Drink3, alt: 'Picture of Cocktail' }
};
export const faceScene = {
  icon: { src: AboutUs, alt: 'Get Litty icon' },
  Face1: { src: Face1, alt: 'Francesca' },
  Face2: { src: Face2, alt: 'Chris' },
  Face3: { src: Face3, alt: 'Kenny' },
  Face4: { src: Face4, alt: 'Sara' }
};
